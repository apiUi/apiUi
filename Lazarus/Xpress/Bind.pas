...
type YYRType = record
  ...
  16: (yySFunctionSXX : SFunctionSXX);
  17: (yySFunctionV : SFunctionV);
  18: (yySFunctionX : SFunctionX);
  19: (yyVFunctionV : VFunctionV);
  20: (yyVFunctionD : VFunctionD);
  21: (yyVFunctionS : VFunctionS);
  22: (yyVFunctionSS : VFunctionSS);
  23: (yyVFunctionSX : VFunctionSX);
  24: (yyVFunctionSSS : VFunctionSSS);
  25: (yyVFunctionSSX : VFunctionSSX);
  26: (yyVFunctionSSSS : VFunctionSSSS);
  27: (yyVFunctionX : VFunctionX);
  28: (yyXFunctionD : XFunctionD);
  29: (yyXFunctionS : XFunctionS);
  30: (yyXFunctionSX : XFunctionSX);
  31: (yyXFunctionV : XFunctionV);
  32: (yyXFunctionX : XFunctionX);
  33: (yyXFunctionXX : XFunctionXX);
  34: (yyXFunctionG : XFunctionG);
  35: (yyXFunctionGG : XFunctionGG);
  36: (yyVFunctionG : VFunctionG);
  37: (yyVFunctionGG : VFunctionGG);
  38: (yyVFunctionGGG : VFunctionGGG);
  39: (yyVFunctionGGGG : VFunctionGGGG);
  40: (yyXFunctionObject : XFunctionObject);
  41: (yyObject : TObject);
  42: (yyVFunctionOV : VFunctionOV);
  43: (yyVFunctionOD : VFunctionOD);
  44: (yyVFunctionOS : VFunctionOS);
  45: (yyVFunctionOSS : VFunctionOSS);
  46: (yyVFunctionOSX : VFunctionOSX);
  47: (yyVFunctionOSSS : VFunctionOSSS);
  48: (yyVFunctionOSSX : VFunctionOSSX);
  49: (yyVFunctionOSSSS : VFunctionOSSSS);
  ...
  56: (yySLFunctionOS : SLFunctionOS);
  57: (yySLFunctionOSS : SLFunctionOSS);
end;
