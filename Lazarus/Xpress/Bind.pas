...
type YYRType = record
  ...
  49: (yyVFunctionOSSSB : VFunctionOSSSB);
  50: (yyVFunctionOSSX : VFunctionOSSX);
  51: (yyVFunctionOSSSS : VFunctionOSSSS);
  52: (yyVFunctionOB : VFunctionOB);
  53: (yyVFunctionOX : VFunctionOX);
  54: (yySFunctionOV : SFunctionOV);
  55: (yyXFunctionOV : XFunctionOV);
  56: (yyXFunctionOS : XFunctionOS);
  57: (yyXFunctionOX : XFunctionOX);
  58: (yyXFunctionOXX : XFunctionOXX);
  59: (yySLFunctionOS : SLFunctionOS);
  60: (yySLFunctionOSS : SLFunctionOSS);
end;
